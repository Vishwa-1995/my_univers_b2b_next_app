...
const CreateDigitalProduct = () => {
  ...
  const [AddDigitalOffer, setAddDigitalOffer] = useState<any>({
    offer_name: "",
    code: "",
    link: "",
  ...
  console.log("images", AddDigitalOffer.image);
  ...
  const handleImageDrop = (acceptedFiles: any) => {
    ...
    setAddDigitalOffer({
      ...AddDigitalOffer,
      image: [...AddDigitalOffer.image, ...acceptedFiles],
    });
  };
  ...
  const createDigitalOffer = async ({ e }: any) => {
    ...
    const details = {
      offer_name: AddDigitalOffer.offer_name,
      code: AddDigitalOffer.code,
      link: AddDigitalOffer.link,
      offer_subtype: AddDigitalOffer.offer_subtype,
      price: AddDigitalOffer.price,
      product_name: AddDigitalOffer.product_name,
      product_description: AddDigitalOffer.product_description,
      for_subscription_only: AddDigitalOffer.for_subscription_only,
    };
    ...
    AddDigitalOffer.image.forEach((image: any) => {
      formData.append("images", image);
    });
    formData.append("details", JSON.stringify(details));

    try {
      const response = await fetch(`${baseUrl}/offer/add_degital`, {
        method: "POST",
        body: formData,
      });
      ...
      if (response.ok) {
        Swal.fire({
          title: "Digital Product Successfully Inserted! ",
          icon: "success",
          ...
          <div className="flex flex-col mt-6 ">
            ...
            <div className="flex flex-col items-center gap-5 mt-5 px-2 2xl:px-28 lg:px-20 md:px-20 sm:px-20 ">
              <input
                ...
                value={AddDigitalOffer.offer_name}
                onChange={(e) =>
                  setAddDigitalOffer({
                    ...AddDigitalOffer,
          ...
          <div className="flex flex-col mt-6 ">
            ...
            <div className="flex flex-col items-center gap-5 mt-5 px-2 2xl:px-28 lg:px-20 md:px-20 sm:px-20 ">
              <input
                ...
                value={AddDigitalOffer.product_name}
                onChange={(e) =>
                  setAddDigitalOffer({
                    ...AddDigitalOffer,
              ...
              <textarea
                ...
                value={AddDigitalOffer.product_description}
                onChange={(e) =>
                  setAddDigitalOffer({
                    ...AddDigitalOffer,
          ...
          <div className="flex flex-col mt-6 ">
            ...
            <div className="flex flex-col items-center gap-5 mt-5 px-2 2xl:px-28 lg:px-20 md:px-20 sm:px-20 ">
              ...
              <div className="flex flex-wrap">
                {AddDigitalOffer.image.map((file: any, index: any) => (
                  <img
                    key={index}
