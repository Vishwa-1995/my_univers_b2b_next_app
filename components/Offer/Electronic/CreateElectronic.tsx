...
const CreateElectronicProduct = () => {
  ...
  const [AddElectronicOffer, setAddElectronicOffer] = useState<any>({
    offer_name: "",
    code: "",
    link: "",
  ...
  const handleImageDrop = (acceptedFiles: any) => {
    ...
    setAddElectronicOffer({
      ...AddElectronicOffer,
      image: [...AddElectronicOffer.image, ...acceptedFiles],
    });
  };

  // Function to create a fashion offer
  const createElectronicOffer = async ({ e }: any) => {
    // setLoading(true);

    const details = {
      offer_name: AddElectronicOffer.offer_name,
      code: AddElectronicOffer.code,
      link: AddElectronicOffer.link,
      offer_subtype: AddElectronicOffer.offer_subtype,
      department: AddElectronicOffer.department,
      brands: AddElectronicOffer.brands,
      seller: AddElectronicOffer.seller,
      product_name: AddElectronicOffer.product_name,
      price: AddElectronicOffer.price,
      product_description: AddElectronicOffer.product_description,
      for_subscription_only: AddElectronicOffer.for_subscription_only,
    };
    ...
    AddElectronicOffer.image.forEach((image: any) => {
      formData.append("images", image);
    });
    formData.append("details", JSON.stringify(details));

    try {
      const response = await fetch(`${baseUrl}/offer/add_electronic`, {
        method: "POST",
        body: formData,
      });
      ...
      if (response.ok) {
        Swal.fire({
          title: "Electronic Product Successfully Inserted! ",
          icon: "success",
          confirmButtonColor: "#01B3BB",
        }).then((res) => {
          if (res.isConfirmed) {
            router.push("/electronic/products");
          }
        });
        ...
        Swal.fire({
          title: "Error occured ! ",
          text: `Failed to add electronic product`,
          icon: "error",
          confirmButtonColor: "#01B3BB",
        });
      }
          ...
          <div className="flex flex-col mt-6 ">
            ...
            <div className="flex flex-col items-center gap-5 mt-5 px-2 2xl:px-28 lg:px-20 md:px-20 sm:px-20 ">
              <input
                ...
                value={AddElectronicOffer.offer_name}
                onChange={(e) =>
                  setAddElectronicOffer({
                    ...AddElectronicOffer,
            ...
            <div className="flex flex-col items-center gap-5 mt-5 px-2 2xl:px-28 lg:px-20 md:px-20 sm:px-20 ">
              <div className="flex flex-row gap-4 items-center justify-between w-full">
                <input
                  ...
                  value={AddElectronicOffer.product_name}
                  onChange={(e) =>
                    setAddElectronicOffer({
                      ...AddElectronicOffer,
              ...
              <textarea
                ...
                value={AddElectronicOffer.product_description}
                onChange={(e) =>
                  setAddElectronicOffer({
                    ...AddElectronicOffer,
              ...
              <div className="flex flex-row gap-4 items-center justify-between w-full">
                <input
                  ...
                  value={AddElectronicOffer.brands}
                  onChange={(e) =>
                    setAddElectronicOffer({
                      ...AddElectronicOffer,
                ...
                <input
                  ...
                  value={AddElectronicOffer.seller}
                  onChange={(e) =>
                    setAddElectronicOffer({
                      ...AddElectronicOffer,
              ...
              <div className="flex flex-row gap-4 items-center justify-between w-full">
                <input
                  className="w-full h-[50px] flex items-center rounded-[10px] border border-[#01B3BB] pt-[14px]  pb-[14px] pl-[20px] placeholder-rgba(30, 30, 30, 0.7) placeholder:font-inter placeholder:text-[12px] font-[400]  "
                  placeholder="Enter Product departmnet"
                  value={AddElectronicOffer.department}
                  onChange={(e) =>
                    setAddElectronicOffer({
                      ...AddElectronicOffer,
                ...
                <input
                  ...
                  value={AddElectronicOffer.price}
                  onChange={(e) =>
                    setAddElectronicOffer({
                      ...AddElectronicOffer,
          ...
          <div className="flex flex-col mt-6 ">
            ...
            <div className="flex flex-col items-center gap-5 mt-5 px-2 2xl:px-28 lg:px-20 md:px-20 sm:px-20 ">
              ...
              <div className="flex flex-wrap">
                {AddElectronicOffer.image.map((file: any, index: any) => (
                  <img
                    key={index}
              ...
              <button
                className="w-full h-[67.19px] flex-shrink-0 border rounded-[10px] bg-[#01B3BB] text-[#FEFCFE] font-montserrat font-semibold text-[18px] uppercase"
                onClick={createElectronicOffer}
              >
                Create Electronic Offer
              </button>
            </div>
          </div>
        )}
...
export default CreateElectronicProduct;
