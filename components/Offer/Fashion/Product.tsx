...
import ViewFashion from "./ViewFashion";
...
export default function Product() {
  ...
  const openAddForm = () => {
    if (isProductActive === true) {
      ...
      router.push('/fashion/product-offer');
  ...
  return (
    <div>
      <div className="container 2xl:px-20 px-2 mx-auto flex justify-between py-10">
        ...
        <button
          className="bg-[#00868e] text-white px-4 py-2 rounded-full xl:w-32 xl:h-14 2xl:w-36 2xl:h-16"
          onClick={openAddForm}
        >
          {isVoucherActive
            ? "Add Voucher"
