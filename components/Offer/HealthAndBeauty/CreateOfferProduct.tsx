...
export default function CreateOfferProduct() {
  ...
  //   OFFER_SUBTYPE = [('vouchers','vouchers'),
  //                  ('products','products')]
  const [AddHealthOffer, setAddHealthOffer] = useState<any>({
    offer_name: "",
    code: "",
    link: "",
  ...
  const handleImageDrop = (acceptedFiles: any) => {
    ...
    setAddHealthOffer({
      ...AddHealthOffer,
      image: [...AddHealthOffer.image, ...acceptedFiles],
    });
  };

  // const createOffer = () => {
  //   console.log({AddHealthOffer})
  ...
  const createOffer = async ({ e }: any) => {
    ...
    const details = {
      offer_name: AddHealthOffer.offer_name,
      code: AddHealthOffer.code,
      link: AddHealthOffer.link,
      for_subscription_only: AddHealthOffer.for_subscription_only,
      offer_subtype: AddHealthOffer.offer_subtype,
      product_name: AddHealthOffer.product_name,
      product_type: AddHealthOffer.product_type,
      product_description: AddHealthOffer.product_description,
      concern: AddHealthOffer.concern,
      brand: AddHealthOffer.brand,
      price: AddHealthOffer.price,
      // image: AddHealthOffer.image,
    };
    ...
    AddHealthOffer.image.forEach((image: any) => {
      formData.append("images", image);
    });
    formData.append("details", JSON.stringify(details));

    try {
      const response = await fetch(`${baseUrl}/offer/health_beauty`, {
        method: "POST",
        body: formData,
      });
          ...
          <div className="flex flex-col mt-6 ">
            ...
            <div className="flex flex-col items-center gap-5 mt-5 px-2 2xl:px-28 lg:px-20 md:px-20 sm:px-20 ">
              <input
                ...
                value={AddHealthOffer.offer_name}
                onChange={(e) =>
                  setAddHealthOffer({
                    ...AddHealthOffer,
            ...
            <div className="flex flex-col items-center gap-5 mt-5 px-2 2xl:px-28 lg:px-20 md:px-20 sm:px-20 ">
              <div className="flex flex-row gap-4  w-full">
                <input
                  ...
                  value={AddHealthOffer.product_name}
                  onChange={(e) =>
                    setAddHealthOffer({
                      ...AddHealthOffer,
                ...
                <input
                  ...
                  value={AddHealthOffer.product_type}
                  onChange={(e) =>
                    setAddHealthOffer({
                      ...AddHealthOffer,
              ...
              <textarea
                ...
                value={AddHealthOffer.product_description}
                onChange={(e) =>
                  setAddHealthOffer({
                    ...AddHealthOffer,
              ...
              <input
                className="w-full h-[50px] flex items-center rounded-[10px] border border-[#01B3BB] pt-[14px] pr-[75px] pb-[14px] pl-[20px] placeholder-rgba(30, 30, 30, 0.7) text-[12px] font-inter  placeholder:font-inter placeholder:text-[12px] font-[400]"
                placeholder="Enter Offer Name"
                value={AddHealthOffer.concern}
                onChange={(e) =>
                  setAddHealthOffer({
                    ...AddHealthOffer,
          ...
          <div className="flex flex-col mt-6 ">
            ...
            <div className="flex flex-col items-center gap-5 mt-5 px-2 2xl:px-28 lg:px-20 md:px-20 sm:px-20 ">
              ...
              <div className="flex flex-wrap">
                {AddHealthOffer.image.map((file: any, index: any) => (
                  <img
                    key={index}
